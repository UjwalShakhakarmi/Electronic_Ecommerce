...
<div class="Product_head p-5">
    <form action="{{url('Update_product/'.$Product->id)}}"enctype="multipart/form-data" style="padding: 15px 30px 30px 30px;"
                ...
                <section>
                    <div class="container" style="padding-top: 20px;">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('Product-category') is-invalid @enderror" name="Category">
                                <option @if($Product->Category == 'Gaming Series') selected @endif
                                    value="Gaming Series">Gaming Series</option>
                                <option @if($Product->Category == 'Other Series') selected @endif
                                    value="Other Series">Other Series</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="Product-Type" class="form-select @error('Type') is-invalid @enderror"
                                name="Type">

                                <option @if($Product->Type == 'Laptop') selected @endif value="Laptop">
                                    Laptop</option>
                                <option @if($Product->Type== 'Other Accessories') selected @endif value="Other
                                    Accessories">
                        ...
                        <div class="d-flex" style="justify-content: space-between;">
                            <div class="mb-3 ">
                                ...
                                <input type="number" class="form-control @error('Actual_Price') is-invalid @enderror"
                                    name="Actual_Price" value="{{ $Product->Actual_Price }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('Brand') is-invalid @enderror"
                                name="Product_Img" >
                            <img src="{{ asset('/storage/'.$Product->Product_Img) }}" style="height: 30px;" alt="">
                    ...
                    <div class="container" style="padding-top: 20px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('HighLight_Heading') is-invalid @enderror"
                                name="HighLight_Heading" placeholder="Hightlight Heading"  value="{{ $Product->HighLight_Heading }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Product Description"
                                id="summernote_Hight_Design" name="HighLight_Desc" style="height: 100px">{{ $Product->HighLight_Desc }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Product Specification" name="Specification"
                                id="summernote_spec" style="height: 100px">{{ $Product->Specification }}</textarea>
                    ...
                    <div class="container" style="padding-top: 20px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('Meta') is-invalid @enderror"
                                name="Meta_Title" placeholder="Hightlight Heading" value="{{ $Product->Meta_Title }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Meta Description" name="Meta_Desc"
                                id="summernote_Meta_Desc" style="height: 100px" value="{{ $Product->Meta_Desc }}"></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Meta Keyword" name="Meta_Key"
                                style="height: 100px" value="{{ $Product->Meta_Key }}"></textarea>
                        ...
                        <div class="row">
                            <div class="mb-3 p-2">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="new_arrival" class="form-check-input" {{ $Product->new_arrival == '1'? 'checked': '' }}>
                                </div>
                            </div>
                            <div class="mb-3 p-2">
                                <label for="">Featured Products</label>
                                <input type="checkbox" name="Featured_products" class="form-check-input" {{ $Product->Featured_products == '1'? 'checked': '' }}>
                            </div>
                            <div class="mb-3 p-2">
                                <div class="form-group">
                                    <label for="">Popular Products</label>
                                    <input type="checkbox" name="popular_products" class="form-check-input" {{ $Product->popular_products == '1'? 'checked': '' }}>
                                </div>
                            </div>
                            <div class="mb-3 p-2">
                                <div class="form-group">
                                    <label for="">Offer Products</label>
                                    <input type="checkbox" name="offers_products" class="form-check-input"{{ $Product->offers_products == '1'? 'checked': '' }} >
                                </div>
                            </div>
                            <div class="mb-3 p-2">
